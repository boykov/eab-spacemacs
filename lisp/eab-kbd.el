...
(define-key eab/wg-map (kbd "f") (ilam (eab/wg-switch-to-workgroup ":ccfebras:")))
...
(define-key eab/wg-map (kbd "C-e") (ilam (eab/wg-switch-to-workgroup ":dotspace:")))
(define-key eab/wg-map (kbd "e") (ilam (eab/wg-switch-to-workgroup ":eab-spacemacs:")))
...
(define-key eab/wg-map (kbd "n") 'eab/wg-create-workgroup-xxx) ;; +
